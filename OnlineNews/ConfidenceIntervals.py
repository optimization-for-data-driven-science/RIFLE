...
# data = pd.read_csv('Facebook_MNAR_60_300_noy.csv', header=None)
data = pd.read_csv('Facebook_MNAR_60_300_noy.csv')
...
np.savetxt("conf_matrix_nmar60_full.csv", confidence_matrix, delimiter=",")
np.savetxt("conf_list_nmar60_full.csv", conf_list, delimiter=",")
# exit(0)
"""

confidence_matrix = np.loadtxt('conf_matrix_nmar60_full.csv', delimiter=',')
conf_list = np.loadtxt('conf_list_nmar60_full.csv', delimiter=',')
