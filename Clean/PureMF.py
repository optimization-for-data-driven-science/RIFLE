...
imputed_data = pd.read_csv('totalMF_95_3000_1000.csv')

print(imputed_data)
# imputed_data = imputed_data[1700:]

Y_imputed = imputed_data[[imputed_data.columns[-1]]]
print(Y_imputed)
...
Y_real = test_data[['critical_temp']]
print(Y_real)
...
mse = np.linalg.norm(Y_real - Y_imputed) ** 2 / Y_real.shape[0]

print("Std: ", sqrt(Y_real.var()))
print("Test MSE: ", mse)
print("Test RMSE: ", np.sqrt(mse))
print(np.sqrt(mse) / sqrt(Y_real.var()))
exit(0)
