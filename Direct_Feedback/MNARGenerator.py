...
training_data = read_dataset('train_data.csv')

training_data = sample_data(training_data, 5000)
final = generate_MNAR_data(training_data, q_low=0, q_high=0.9, scale=3, shift=0, no_y=False)
print(final)
exit(0)
training_data.to_csv("feedback_original_MNAR_P60_5000.csv", index=None)
final.to_csv("feedback_missing_MNAR_P60_5000.csv", index=None)
