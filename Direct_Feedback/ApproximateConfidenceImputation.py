...
data_validation = data[np.isfinite(data['280'])]

data_validation = data_validation.fillna(data_validation.mean())
Y_validation = data_validation[['280']]
X_validation = data_validation.drop(['280'], axis=1)
...
for best_lam in lam_list:
    ...
    original = pd.read_csv('feedback_original_MNAR_P60_5000.csv')
