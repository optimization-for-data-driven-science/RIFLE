...
data = pd.read_csv('train_missing_MCAR40_200.csv', header=None)
...
X_1 = data.loc[data[56] == 1.0]
X_0 = data.loc[data[56] == 0.0]

X_1 = X_1.drop([51, 52, 53, 54, 55, 56], axis=1)
columns = X_1.columns
ind = X_1.index
X_1 = sc.transform(X_1)
X_1 = pd.DataFrame(X_1, columns=columns, index=ind)

X_0 = X_0.drop([51, 52, 53, 54, 55, 56], axis=1)
columns = X_0.columns
ind = X_0.index
...
X_test = test.drop([51, 52, 53, 54, 55, 56], axis=1)
