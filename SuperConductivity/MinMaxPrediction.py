...
step_size_list = [1.1e-7]

number_of_iterations_list = [700000]

vals = []
iterations = []

for step_size in step_size_list:
    for number_of_iterations in number_of_iterations_list:
        ...
        for i in range(number_of_iterations):
            ...
            theta = np.dot(np.linalg.inv(C1 + lam * ident), b1)
