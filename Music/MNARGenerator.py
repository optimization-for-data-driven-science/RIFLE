...
training_data = read_dataset('YearPredictionMSD.csv')

training_data = sample_data(training_data, 3000)
final = generate_MNAR_data(training_data, q_low=0.2, q_high=1, scale=1, shift=0, no_y=False)
print(final)
training_data.to_csv("music_original_MNAR_P80_3000_2.csv", index=None)
final.to_csv("music_missing_MNAR_P80_3000_2.csv", index=None)
